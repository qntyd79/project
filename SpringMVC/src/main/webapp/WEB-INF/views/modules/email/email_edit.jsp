                ...
                <section class="content">
                    ...
                    <article>
                        <div class="row">
                            <div class="col-md-12">
                                <h2>글쓰기</h2>
                                 <form name="writeForm" method="post" enctype="multipart/form-data" action="<c:url value='update.do'/>" >
                                        ...
                                        <table summary="기본게시판 보여주고 있습니다." class="table">
                                            ...
                                            <tbody>                                                
                                                <tr>
                                                    ...
                                                    <td class="text-left"><input type="text" id="userid" name="userid" value="<c:out value=" ${dto.userid}" />"> <span>6~12자의 영문 소문자, 숫자만 사용할 수 있습니다.</span></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="pw"> 비밀번호 </label></th>
                                                    <td class="text-left"><input type="password" id="pass" name="pass" "> <span>6~12자의 영문 소문자, 숫자만 사용할 수 있습니다.</span></td>
                                                </tr>                                                
                                                <tr>
                                                    <th><label for="toemail"> 받는사람 </label></th>
                                                    <td class="text-left"><input type="text" id="toemail" name="toemail" value="<c:out value=" ${dto.toemail}" />"/></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="sendemail"> 보내는사람 </label></th>
                                                    <td class="text-left"><input type="text" id="sendemail" name="sendemail" value="<c:out value=" ${dto.sendemail}" />"/></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="title"> 제목 </label></th>
                                                    <td class="text-left"><input type="text" id="title" name="title" value="<c:out value=" ${dto.title}" />"></td>
                                                </tr>                                               
                                               	<tr>
                                                    <td colspan="10" class="text-left">
                                                        <textarea name="content" id="editor" placeholder="Content"><c:out value="${dto.content}"/></textarea>
                                                        <script>
