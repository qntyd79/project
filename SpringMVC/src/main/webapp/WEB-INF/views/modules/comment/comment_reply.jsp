                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 ...
                                 <form method="post" id="writeForm" name="writeForm" enctype="multipart/form-data" action="insert.do">
                                    ...
                                    <input type="hidden" name="parent" value="<c:out value=" ${commentVO.parent}"/>" >
                                    <input type="hidden" name="depth" value="<c:out value=" ${commentVO.depth}"/>" >
                                    <input type="hidden" name="sortno" value="<c:out value=" ${commentVO.sortno}"/>" >
                                        ...
                                        <table summary="<spring:message code="bbs.table.summary.write"/>" class="board_detail">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><input name="email" type="text" placeholder="Email" class="wfull"/> <form:errors path="email" /></td>
                                                </tr>
                                                <tr>
