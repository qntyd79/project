                                        ...
                                        <table summary="기본게시판 보여주고 있습니다." class="table">
                                            ...
                                            <tbody>
                                                        ...
                                                        <div class="layer">
                                                            ...
                                                            <div id="layer1" class="pop-layer">
                                                                <div class="pop-container">
                                                                    <div class="pop-conts">
                                                                        <iframe name="ifrm_file" src="${path}/modules/category/list.do" height="680px" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" style="width:100%;"></iframe>
                                                                        <div class="btn-r">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><input type="text" id="homepage" name="homepage" value="domain.co.kr" placeholder="Homepage" /></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="title"> 제목 </label></th>
                                                    <td class="text-left"><input type="text" id="title" name="title" value="제목테스트입니다." placeholder="Title"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        ...
                                                        <input type="checkbox" name="mailsend" value="1" id="mailsend"> 소스코드
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><input type="text" id="link1" name="link1" value="link1.co.kr" placeholder="Link1"></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="link2"> 관련링크2 </label></th>
                                                    <td class="text-left"><input type="text" id="link2" name="link2" value="link2.co.kr" placeholder="Link2"></td>
                                                </tr>
                                                <tr>
...
$(document).ready(function() {
    ...
    function audio() {
        ...
        var url = '/modules/board/captchaAudio.do';
        $.ajax({
            url: url,
            type: 'POST',
            dataType: 'text',
            ...
            success: function(resp) {
                ...
                var soundUrl = '/modules/board/captchaAudio.do?rand=' + rand;

                if (uAgent.indexOf('Trident') > -1 || uAgent.indexOf('MSIE') > -1) {
                    winPlayer(soundUrl);
                } else if (!!document.createElement('audioBtn').canPlayType) {
                    try {
    ...
    function refreshBtn(type) {
        var rand = Math.random();
        var url = "/modules/board/captchaImg.do?rand=" + rand;
