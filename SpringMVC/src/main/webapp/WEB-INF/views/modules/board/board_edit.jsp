                    ...
                    <article>
                        <div class="row">
                            <div class="col-md-12">   
                                ...
                                <form:form modelAttribute="boardVO" method="post" id="writeForm" name="writeForm" enctype="multipart/form-data" action="update.do">
                                        ...
                                        <table summary="<spring:message code="bbs.table.summary.edit"/>" class="board_detail">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        <input type="checkbox" name="notice" value="1" <c:if test="${boardVO.notice == 1}">
                                                        <c:out value="checked" />
                                                        </c:if>> 공지사항
                                                        <input type="checkbox" name="secret" value="1" <c:if test="${boardVO.secret == 1}">
                                                        <c:out value="checked" />
                                                        </c:if>> 비밀글
                                                        <input type="checkbox" name="mailsend" value="1" <c:if test="${boardVO.tag == 1}">
                                                        <c:out value="checked" />
                                                        </c:if>> 소스코드
                                                    </td>
                                                </tr>
