                            ...
                            <div class="col-md-12">
                                ...
                                <form name="readForm" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                        ...
                                        <nav class="btn-group">
											<ul>												
												<li><input type="button" value="<spring:message code="button.list"/>" onClick="location.href='ajaxlist.do?page=${criteria.page}&perPageNum=${criteria.perPageNum}'" /></li>
										        <li><input type="button" value="<spring:message code="button.update"/>" onClick="location.href='ajaxedit.do?page=${criteria.page}&perPageNum=${criteria.perPageNum}&board_idx=<c:out value="${boardVO.board_idx}" />&category_idx=<c:out value="${boardVO.category_idx}" />'" /></li>
										        <li><input type="button" value="<spring:message code="button.reply"/>" onClick="location.href='ajaxreply.do?page=${criteria.page}&perPageNum=${criteria.perPageNum}&board_idx=<c:out value="${boardVO.board_idx}" />'" /></li>
										        <li><input type="button" value="<spring:message code="button.delete"/>" onClick="location.href='ajaxdelete.do?page=${criteria.page}&perPageNum=${criteria.perPageNum}&board_idx=<c:out value="${boardVO.board_idx}" />'" /></li>
											</ul>
										</nav>                                       
