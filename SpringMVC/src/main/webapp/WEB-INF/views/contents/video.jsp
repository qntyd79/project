        ...
        <div class="slider">
            <div class="slider-item">
                <div class='slider-caption'>
                    <h2 class="slider-title">InnoMaps Service</h2>
                    <h3 class="slider-desc">MMS 원천 기술 확보와 최고 성능의 장비 투입</h3>
                    <h4 class="slider-summary">거리/실내/항공 파노라마 및 정사영상, Point Cloud 수집</h4>
                    <section>
                        <article>
                            <div class="row">
                                <div class="col-md-12">
                ...
                <div class="slider-video">
                    <video width="100%" muted autoplay loop>
                        <source src="/resources/images/slide/wingtra.mp4" type="video/mp4">
                    </video>
                </div>
