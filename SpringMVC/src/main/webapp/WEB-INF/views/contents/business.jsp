            ...
            <div class="content-full-bg01-hidden">
                <section class="content">
                   <%@ include file="../include/content_header.jsp"%>
                    <article>
                        <h2>Business</h2>
                        <div class="lead">차별화된 경쟁력과 기술력을 바탕으로 최고의 제품솔루션과 전문 기술 서비스를 제공하고 있습니다.<BR>
                            (주)이노맵스는 시장 변화에 선제적으로 대응하기 위한 경쟁력 있는 제품과 서비스로 최적의 답안을 제시합니다.</div>
                    </article>
                    <article>
                        <div class="row">
                                ...
                                <ul class="content-panel-3">
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            ...
                                            <h2 class="subtitle">드론용 MMS에서 얻을 수 있는 최상의 데이터 획득이 가능한 장비 제작 및 데이터 수집
                                            </h2>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="thumbnail">
                                            ...
                                            <h2 class="subtitle">MMS 및 드론을 활용한 영상정보, 점군정보, 위치정보 기반 데이터베이스 구축 및 납품</h2>
                                        </div>
                                    </li>
                                </ul>
                            </div>
