                   ...
                   <article>
                    ...
                    <article>
                        ...
                        <div class="lead">nebula-DSLR는 DSLR 전자셔터 모드가 적용 된 파노라마 이미지 수집장치로 교체용 카메라 보유가 필요없으며, 관성항법장치에 기반한 좌표 자세값 획득이 가능합니다. <br>
                            또한 이미지와 로그 파일이 페어링되어 단일미디어(SSD)에 저장, 페어링 작업 및 데이터 정리가 불필요합니다. 향후 5G등 네트워크망을 통해 데이터 자동 전송 가능합니다.<br>
                            ...
                            <div class="col-md-5">
                                <div class="test-box-none">
                                    <div class="panel text-left">
                                        ...
                                        <p>또한 이미지와 로그 파일이 페어링되어 단일미디어(SSD)에 저장, 페어링 작업 및 데이터 정리가 불필요합니다. 향후 5G등 네트워크망을 통해 데이터 자동 전송 가능합니다.</p>
