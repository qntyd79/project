...
public class BoardRestController {
	...
	@GetMapping(value = { "openapi/{pageNo}", "openapi/{pageNo}/{lawdcd}/{dealymd}" })
	public ResponseEntity<Map<String, Object>> aList(@ModelAttribute Criteria criteria,
			@PathVariable("pageNo") int pageNo, @PathVariable("lawdcd") String lawdcd,
			@PathVariable("dealymd") String dealymd) {
		...
		try {
			...
			// JSON객체에서 JAVA객체로 변환
			// Map<String, Object> list = jsonObject.toMap();
