...
public class OpenapiController {
	...
	public String List(Model model, @ModelAttribute Criteria criteria, 
			...
			@RequestParam(value="dealymd", required = false, defaultValue="201510") String dealymd) throws Exception {
	...
	public Map<String, Object> aList(Model model, @ModelAttribute Criteria criteria, 
			@RequestParam("pageNo") int pageNo, @RequestParam("perPageNum") int perPageNum,  
			@RequestParam("lawdcd") String lawdcd, @RequestParam("dealymd") String dealymd)throws Exception {
