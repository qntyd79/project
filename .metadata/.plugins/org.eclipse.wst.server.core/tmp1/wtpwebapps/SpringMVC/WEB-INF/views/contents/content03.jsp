                ...
                <section class="content">
                   <%@ include file="../include/content_header.jsp"%>
                    <article>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">거리뷰 촬영은 DMI(Distance Measurement Instrument)의 정확한 거리측정으로 촬영간격을 10m로 유지하며, 고정밀
                                    항법장치인 Applanix AP-20E로 부터 위도, 경도, 고도 등의 위치정보와 Roll, Pitch, Yaw 등의 카메라 자세정보 취득<br>
                    ...
                    <article>
                        <h2>도보형 거리뷰/실내뷰 촬영</h2>
                        <h3>도보형 거리뷰/실내뷰 촬영장비</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">Nikon D850을 도보형 거리뷰/실내뷰 촬영의 기본 카메라로 서비스 해상도에 적합한 파노라마 헤드와 렌즈 사용<br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">도보형 거리뷰 촬영은 사람 눈높인 1.5m 수준의 일반 촬영과 5m 높이의 고공 촬영으로 구분하며, 촬영 간격은 10m 내외로
                    ...
                    <article>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">고가의 운용비가 소요되는 유인헬기로 동일 지역을 중복 촬영하여 많은 경비를 소모하는 것 보다 운용비가 저렴한 UAV를
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">70~120m의 저고도 촬영에 유용한 UAV를 활용하여 최대 22,000px의 항공뷰 촬영으로 거리뷰에서 볼 수 없는 특정지역의
                                    전체를 조망할 수 있는 서비스<br>
                    ...
                    <article>
                        <h2><i class="fas fa-chess-board"></i> UAV형 항공 정사영상 촬영</h2>
                        <h3>UAV 항공뷰 촬영장비</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">WingtraOne은 스위스에서 개발된 항공 사진측량과 Mapping을 위한 수직이착륙(VTOL-Vertical Take Off & Landing)형
                                    고정익 UAV로 ㈜이노맵스에서 국내 보급을 담당<br>
                        ...
                        <h3>고정익 UAV를 활용한 정사영상 촬영</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">김포, 판교, 별내, 동탄 등 전국적으로 산재한 소규모 신도시 개발 지역에 대한 네이버 항공지도의 갱신 주기 단축<br>
                    ...
                    <article>
                        <h2>차량형 MMS DATA 구축</h2>
                        <h3>차량형 MMS</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">㈜이노맵스에서 자체 개발한 Nebula-LP는 차량에 장착 가능한 MMS로 FOG타입의 고정밀 관성항법장치와 LiDAR 센서가
                                    완벽하게 결합되도록 개발된 제품<br>
                        ...
                        <h3>거리뷰 및 Point Cloud 동시 취득</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">제안사에서 보유하고 있는 MMS(Applanix AP-20E, Quanergy M8)를 활용하여 거리뷰 Raw Data와 HD Map 구축을 위한
                    ...
                    <article>
                        ...
                        <h3>Indoor Mapping</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="lead">지하철, 박물관, 공연장, 쇼핑센터 등 대형 건물의 고정밀 실내 지도 구축을 위한 실내 MMS DATA 취득<br>
